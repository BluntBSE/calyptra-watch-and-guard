    ...
    <footer>
        <div class="footer-container">
            <div class="footer-section">
                ...
                <p>
                    Providing discreet investigative services to distinguished
                    clients since 1961. Established tradition, modern methods.
                </p>
            </div>
            <div class="footer-section">
                <h3>Services</h3>
        ...
        <div class="footer-bottom">
            <p>
                &copy; 2025 Calyptra Watch & Guard. Confidentiality Assured. |
...
<style>
    :global(body) {
        ...
        background-image:
            radial-gradient(
                circle at 20% 80%,
                rgba(120, 119, 109, 0.1) 0%,
                transparent 50%
            ),
            radial-gradient(
                circle at 80% 20%,
                rgba(120, 119, 109, 0.05) 0%,
                transparent 50%
            ),
            radial-gradient(
                circle at 40% 40%,
                rgba(120, 119, 109, 0.03) 0%,
                transparent 50%
            );
    }
    ...
    :global(::selection) {
        background: rgba(166, 139, 107, 0.3);
        color: #f5f3f0;
    }
