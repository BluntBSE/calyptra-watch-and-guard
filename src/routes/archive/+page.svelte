<script lang="ts">
    ...
    onMount(() => {
        ...
        if (typeof window !== "undefined") {
            authenticated =
                sessionStorage.getItem("cwg_authenticated") === "true";
            if (!authenticated) {
                goto("/access");
            }
        }
    ...
    // PDF download function — also navigates to /velvet
    function downloadPDF() {
        const link = document.createElement("a");
        link.href = `/pdfs/case-report-1971.pdf`;
        link.download = "case-report-1971.pdf";
        link.target = "_blank";
        ...
        console.log(
            `Archive access: Downloaded case-report-1971.pdf at ${new Date().toISOString()}`,
        );

        // Brief delay to let the download kick off, then navigate to velvet
        setTimeout(() => {
            goto("/velvet");
        }, 500);
    }
            ...
            <div class="header-left">
                ...
                <div class="status-bar">
                    <span class="status-item"
                        >STATUS: <span class="status-online">ONLINE</span></span
                    >
                    <span class="status-item">USER: ARCHIVE_ADMIN</span>
                    <span class="status-item"
                        >SESSION: {new Date().toLocaleString()}</span
                    >
                </div>
            </div>
                ...
                {#if activeSection === "digitization"}
                    <div class="content-section">
                        ...
                        <div class="project-description">
                            ...
                            <p>
                                Status: COMPLETED | Classification: RESTRICTED
                            </p>
                        ...
                        <div class="access-warning">
                            <p>
                                ⚠ WARNING: These documents contain sensitive
                ...
                {:else}
                    <div class="default-content">
                        ...
                        <div class="welcome-message">
                            <p>
                                Welcome to the Calyptra Watch & Guard Archive
                                System
                            </p>
                            <p>
                                Select a section from the sidebar to access
                                archived materials.
                            </p>
                            <p>
                        ...
                        <div class="recent-activity">
                            ...
                            <div class="activity-log">
                                <div class="log-entry">
                                    2025-09-02 21:45 - Archive access granted
                                </div>
                                <div class="log-entry">
                                    2025-09-02 18:32 - System backup initiated
                                </div>
                                <div class="log-entry">
                                    2025-09-02 14:15 - Maintenance check
                                    completed
                                </div>
                                <div class="log-entry">
                                    2025-09-01 22:08 - User session terminated
                                </div>
                                <div class="log-entry">
                                    2025-09-01 20:45 - File access:
                                    Personnel/Archive
                                </div>
                            </div>
                        </div>
