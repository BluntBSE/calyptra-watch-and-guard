<svelte:head>
	...
	<meta name="description" content="Join the distinguished team at Calyptra Watch & Guard." />
</svelte:head>

<div class="careers-hero">
	<h1>Professional Opportunities</h1>
	<p>Calyptra Watch & Guard maintains a selective approach to expanding our team. We seek individuals of exceptional character and capability who are willing to understand their place in the world.</p>
</div>
...
<div class="job-listing">
	...
	<div class="job-description">
		...
		<ul>
			...
			<li>Update astrological charts with new information in real-time</li>
			<li>Remotely ssist with rodent infestations as needed)</li>
		...
		<ul>
			...
			<li>Willingness to work variable hours, including overnights (triple pay will be provided)</li>
